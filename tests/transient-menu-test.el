...
(defconst imoogi-test--suffix-table
  '((imoogi-transient-window                      ; §C.1 (17)
    ...
    (imoogi-transient-modes
     ...
     (transient-quit-one                 transient--do-quit-one))
    (imoogi-gptel-transient
     (imoogi-gptel-chat                  transient--do-exit)
     (imoogi-gptel-send                  transient--do-exit)
     (imoogi-gptel-menu                  transient--do-exit)
     (gptel-add                          transient--do-exit)
     (gptel-add-file                     transient--do-exit)
     (imoogi-gptel-setup                 transient--do-exit)
     (imoogi-gptel-store-key             transient--do-exit)
     (imoogi-gptel-setup-guide           transient--do-exit)
     (transient-quit-one                 transient--do-quit-one))
    (imoogi-system-transient
     (imoogi-system-set-ca-certificate   transient--do-exit)
     (imoogi-system-clear-ca-certificate transient--do-exit)
     (transient-quit-one                 transient--do-quit-one))
    (imoogi-transient-master                      ; §C.5 (6)
     ...
     (imoogi-system-transient          transient--do-stack)
...
(ert-deftest imoogi-transient-gptel-is-registered-on-master ()
  (should (eq (plist-get (cdr (transient-get-suffix 'imoogi-transient-master "i"))
                         :command)
              #'imoogi-gptel-transient))
