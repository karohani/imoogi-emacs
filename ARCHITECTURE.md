...
2. **02-completion** — ivy/counsel이 먼저 로드되어야 다른 모듈에서 counsel 함수 참조 가능
3. **03-which-key** — Emacs 30 내장
4. **04-projects** — projectile, perspective (counsel에 의존)
5. **05-hydra** — ace-window + hydra 정의 (counsel, projectile, magit 함수 참조)
6. **06-git** — magit (독립적)
